...
//int16_t tempAngles[12] = {100,90,90,100,90,100,100,90,100,90,90,100};
int16_t offset[12] = {10,  4, -11,  8,0,  0,  0, 0,  2, -4,-12, -2};
...
int16_t danceAngles[22][14] = {
// LHR LHP LAP LAR LSP LSR RSR RSP RAR RAP RHP RHR time 
  { 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90,127, 0},
  
  {100, 90, 90,100, 90,110,110, 90,100, 90, 90,100, 16, 0},
  {100, 90, 90,100, 90, 70, 70, 90,100, 90, 90,100, 16, 2},
  { 80, 90, 90, 80, 30,110,110,150, 80, 90, 90, 80, 16, 0},
  { 80, 90, 90, 80, 30, 70, 70,150, 80, 90, 90, 80, 16, 0},
  {100, 90, 90,100, 90,110,110, 90,100, 90, 90,100, 16, 0},
  {100, 90, 90,100, 90, 70, 70, 90,100, 90, 90,100, 16, 0},
  { 80, 90, 90, 80, 30,110,110,150, 80, 90, 90, 80, 16, 0},
  { 80, 90, 90, 80, 30, 70, 70,150, 80, 90, 90, 80, 16, 0},
  ...
  { 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 16, 0}
};
int16_t leftAngles[6][14] = {
// LHR LHP LAP LAR LSP LSR RSR RSP RAR RAP RHP RHR time 
  { 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 8, 0},
  { 90, 90, 90,100, 90, 90, 90, 90,100, 90, 90, 90, 8, 0},
  {100, 90, 90,100, 90, 90, 90, 90,100, 90, 90, 90, 8, 0},
  { 90, 90, 90, 80, 90, 90, 90, 90, 80, 90, 90, 80, 8, 0},
  { 90, 90, 90, 80, 90, 90, 90, 90, 80, 90, 90, 90, 8, 0},
  { 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 8, 0}
};
int16_t rghtAngles[6][14] = {
// LHR LHP LAP LAR LSP LSR RSR RSP RAR RAP RHP RHR time 
  { 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 8, 0},
  { 90, 90, 90, 80, 90, 90, 90, 90, 80, 90, 90, 90, 8, 0},
  { 90, 90, 90, 80, 90, 90, 90, 90, 80, 90, 90, 80, 8, 0},
...
int16_t rtrnAngles[8][14] = {
// 常に右重心にしました。
//LHR LHP LAP LAR LSP LSR RSR RSP RAR RAP RHP RHR time
  {90,100,100, 90, 90, 90, 90, 90, 90,100,100, 90, 8, 0},
  {90, 90, 90,100, 80, 90, 90, 80, 90,100,100, 90, 8, 0}, //右重心
  {90, 90, 90,100, 70, 90, 90, 70, 90, 90, 90, 90, 4, 0},
  {90, 90, 90,100, 80, 90, 90, 80, 90, 80, 80, 90, 4, 0}, //右足前
  {90, 80, 80, 90, 90, 90, 90, 90, 90, 80, 80, 90, 8, 0},
  {90, 80, 80,100,100, 90, 90,100,100, 90, 90, 90, 8, 0}, //右重心
  {90, 90, 90, 90,110, 90, 90,110,100, 90, 90, 90, 4, 0},
  {90,100,100, 90,100, 90, 90,100,100, 90, 90, 90, 4, 0}  //左足前
};
int16_t ltrnAngles[8][14] = {
// 常に左重心にしました。
//LHR LHP LAP LAR LSP LSR RSR RSP RAR RAP RHP RHR time
  ...
  {90,100,100, 90, 90, 90, 90, 90, 90,100,100, 90, 8, 0},
  {90, 90, 90, 80, 80, 90, 90, 90, 80,100,100, 90, 8, 0}, //左重心
  {90, 90, 90, 80, 70, 90, 90, 70, 90, 90, 90, 90, 4, 0},
  {90, 90, 90, 80, 80, 90, 90, 90, 90, 80, 80, 90, 4, 0}, //右足前
  {90, 80, 80, 90, 90, 90, 90, 90, 90, 80, 80, 90, 8, 0},
  {90, 80, 80, 90,100, 90, 90,100, 90, 90, 90, 90, 8, 0}, //左重心
  {90, 90, 90, 90,110, 90, 90,110, 90, 90, 90, 90, 4, 0},
  {90,100,100, 90,100, 90, 90,100, 90, 90, 90, 90, 4, 0}  //左足前
};
int16_t bwrdAngles[8][14] = { //後退
// 順番を逆にしました。
//LHR LHP LAP LAR LSP LSR RSR RSP RAR RAP RHP RHR time
  {90,100,100, 90,100, 90, 90,100,100, 90, 90, 90, 4, 0}, //左足前
  {90, 90, 90, 90,110, 90, 90,110,100, 90, 90, 90, 4, 0},
  {90, 80, 80,100,100, 90, 90,100,100, 90, 90, 90, 8, 0}, //右重心
  {90, 80, 80, 90, 90, 90, 90, 90, 90, 80, 80, 90, 8, 0},
  {90, 90, 90, 80, 80, 90, 90, 80, 90, 80, 80, 90, 4, 0}, //右足前
  {90, 90, 90, 80, 70, 90, 90, 70, 90, 90, 90, 90, 4, 0},
  {90, 90, 90, 80, 80, 90, 90, 80, 80,100,100, 90, 8, 0}, //左重心
  {90,100,100, 90, 90, 90, 90, 90, 90,100,100, 90, 8, 0}
};
int16_t fwrdAngles[8][14] = {
//LHR LHP LAP LAR LSP LSR RSR RSP RAR RAP RHP RHR time
  {90,100,100, 90, 90, 90, 90, 90, 90,100,100, 90, 8, 0},
  {90, 90, 90, 80, 80, 90, 90, 80, 80,100,100, 90, 8, 0}, //左重心
  {90, 90, 90, 80, 70, 90, 90, 70, 90, 90, 90, 90, 2, 1},
  {90, 90, 90, 80, 80, 90, 90, 80, 90, 80, 80, 90, 2, 0}, //右足前
  {90, 80, 80, 90, 90, 90, 90, 90, 90, 80, 80, 90, 8, 0},
  {90, 80, 80,100,100, 90, 90,100,100, 90, 90, 90, 8, 0}, //右重心
  {90, 90, 90, 90,110, 90, 90,110,100, 90, 90, 90, 2, 0},
  {90,100,100, 90,100, 90, 90,100,100, 90, 90, 90, 2, 0}  //左足前
};
int16_t motionAngles[34][14];
uint8_t maxRows;
uint8_t divCounter;
uint8_t keyFrame;
...
void IRAM_ATTR onTimer(){
  ...
  switch(soundNum){
    ...
    break;
    case 2:
    if(wavCounter < sound_length2) dacWrite(25,sound_data2[wavCounter++]);
    else stop_playback();
    break;
  }
  ...
  if(rmReceived){ //リモコン受信した
    ...
    if((dataCode + invDataCode) == 0xff){   //反転確認
      if(dataCode == 22 || dataCode == 66 || dataCode == 74) {
        ...
        case 13:  //"c"ボタン
          actionMode = DANCE;
          memcpy(motionAngles, danceAngles, sizeof(danceAngles));
          maxRows = sizeof(danceAngles) / sizeof(*danceAngles) - 1;
          break;
        default:
        break;
        }
  ...
  if(actionMode != STOP && svFlag){
    ...
    if(actionMode == ARM){
      ...
      if(divCounter >= motionAngles[nextKeyFrame][12]) {
        ...
        if(motionAngles[nextKeyFrame][13] != 0)start_playback(motionAngles[nextKeyFrame][13]);
      }
      for(int i=0; i<12; i++) {
        tempAngles[i] = motionAngles[keyFrame][i] +
            int8_t((motionAngles[nextKeyFrame][i] - motionAngles[keyFrame][i])
